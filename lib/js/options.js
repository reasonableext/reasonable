(function() {
  ...
  buildControll = function($td, key, value, comp) {
    return $td.append(("<input id='" + key + "_" + comp.value + "' type='radio' name='" + key + "' checked='" + (value === comp.value) + "' value='" + comp.value + "'>") + ("<label for='" + key + "_" + comp.value + "' class='actions'>" + comp.label + "</label>"));
  };
